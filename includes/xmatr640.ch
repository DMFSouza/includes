	...
	#define STR0039 "Fact Cred "
		...
		#define STR0003 "It can be ordered by Date+Number,"
	...
	#else
		#define STR0001  "Relacao de Duplicatas"
		#define STR0002  "Este programa ira emitir a relacao de duplicatas"
		#define STR0003  "emitidas.Podera ser emitida por Ordem de Data+Numero, "
		#define STR0004  "por Vendedor."
		#define STR0005  "Numero"
		...
		#define STR0008  "Vendedor"
		#define STR0009  "Cliente"
		#define STR0012  "RELACAO DAS DUPLICATAS EMITIDAS - "
		#define STR0013  "PRF NUMERO       P CODIGO LJ RAZAO SOCIAL                      EMISSAO     VENCTO                 VALOR   SUPERV. VENDEDOR    PEDIDO"
		#define STR0014  "                                                                                                  TOTAL"
		#define STR0015  "CANCELADO PELO OPERADOR"
		#define STR0016  "Total Do Vendedor   ==> "
		#define STR0017  "Total dos Emitidos em ==> "
		#define STR0018  "Total dos Vencidos em ==> "
		#define STR0019  "Total do Cliente ==> "
		#define STR0020  "TOTAL ---------------->"
		#define STR0021  "PRF NUMERO       P CODIGO               LOJA RAZAO SOCIAL              EMISSAO     VENCTO                VALOR SUPERV. VEND.  PEDIDO"
		#define STR0022  "                                                                                                         TOTAL"
		#define STR0023  "Total Liquido"
		#define STR0024  "TOTAL LIQUIDO"
		#define STR0025  "Relacao de Duplicatas"
		#define STR0026  "Este programa ira emitir a relacao de duplicatas"
		#define STR0027  "emitidas.Podera ser emitida por Ordem de Titulo, "
		#define STR0028  "Emissao, Vencimento, Vendedor ou Cliente."
		#define STR0029  "Numero"
		#define STR0030  "Emissao"
		#define STR0031  "Vencimento"
		#define STR0032  "Vendedor"
		#define STR0033  "Cliente"
		#define STR0034  "Total dos Emitidos em ==> "
		#define STR0035  "Total dos Vencidos em ==> "
		#define STR0036  "Total do Cliente ==> "
		#define STR0037  "Total Liquido"
		#define STR0038  "Total do Vendedor ==> "
	...
	If Type('cPaisLoc') == 'C'
		...
		If cPaisLoc == "ANG"
			STR0001 := "Relação De Duplicatas"
			STR0002 := "Este programa irá emitir a relação de duplicatas"
			STR0003 := "Emitidas.poderá ser emitida por ordem de data+número, "
			STR0004 := "Por Vendedor."
			STR0005 := "Número"
			STR0006 := "Emissão"
			STR0012 := "Relação das duplicatas emitidas - "
			STR0013 := "Prf Número       P Código  Lj Razao Social                      Emissão     Vencto                 Valor   Superv. Vendedor    Pedido"
			STR0014 := "                                                                                                  Total"
			STR0015 := "Cancelado Pelo Operador"
			STR0016 := "Total do vendedor   ==> "
			STR0017 := "Total dos emitidos em ==> "
			STR0018 := "Total dos vencidos em ==> "
			STR0019 := "Total do cliente ==> "
			STR0020 := "Total ---------------->"
			STR0021 := "Prf Número       P Código                Loja Razao Social              Emissão     Vencto                Valor Superv. Vend.  Pedido"
			STR0022 := "                                                                                                         Total"
			STR0023 := "Total Líquido"
			STR0024 := "Total Líquido"
			STR0025 := "Relação De Duplicatas"
			STR0026 := "Este programa irá emitir a relação de duplicatas"
			STR0027 := "Emitidas.poderá ser emitida por ordem de título, "
			STR0028 := "Emissão, Vencimento, Vendedor Ou Cliente."
			STR0029 := "Número"
			STR0030 := "Emissão"
			STR0034 := "Total dos emitidos em ==> "
			STR0035 := "Total dos vencidos em ==> "
			STR0036 := "Total do cliente ==> "
			STR0037 := "Total Líquido"
			STR0038 := "Total do vendedor ==> "
		ElseIf cPaisLoc == "PTG"
			STR0001 := "Relação De Duplicatas"
			STR0002 := "Este programa irá emitir a relação de duplicatas"
			STR0003 := "Emitidas.poderá ser emitida por ordem de data+número, "
