	...
	#define STR0026 "Titulos p. cobrar"
		...
		//#define STR0004 If( cPaisLoc $ "ANG|PTG", "NUMERO    PARC TIP CLIENTE    LOJA   CNPJ           NOME DO CLIENTE                       CIDADE                          EMISSÃO      VENCIMENTO         VALOR             SALDO         PORTADOR                         ", "NÚMERO         PARC TIP CLIENTE    LOJA   CNPJ           NOME DO CLIENTE                     CIDADE                       EMISSÃO      VENCIMENTO         VALOR             SALDO         PORTADOR                         " )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "CGC           LOJA   CLIENTE     NOME DO CLIENTE                       CIDADE              NUMERO         PARC   TIPO     EMISSÃO      VENCIMENTO         VALOR             SALDO         PORTADOR                         ", "CGC           LOJA   CLIENTE     NOME DO CLIENTE                       CIDADE              NUMERO         PARC   TIPO     EMISSÃO      VENCIMENTO         VALOR             SALDO         PORTADOR                         " )
