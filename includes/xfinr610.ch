	...
	#define STR0047 "P/T"
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Prf Título       Prc Código Lj Nome                 Data De    Data               Valor      Emissão      Emissão    Valor Base %comis   Valor Total P/t", "PRF TITULO       PRC CODIGO LJ NOME                 DATA DE    DATA               VALOR      COMISSAO      COMISSAO    VALOR BASE %COMIS   VALOR TOTAL P/T" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "    pedido           cliente                        emissão    vencto            título     p/emissão       p/liquidação      p/ liquidação  total   da emissão    ", "    PEDIDO           CLIENTE                        EMISSAO    VENCTO            TITULO     P/EMISSAO       P/BAIXA      P/ BAIXA  TOTAL   DA COMISSAO    " )
